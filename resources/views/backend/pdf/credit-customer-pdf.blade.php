...
<body>
    ...
    <h4 style="color: red;">Credit Summary</h4>   
    <table style="width: 100%; margin-bottom:100px">
        ...
        <tbody>
            ...
            @foreach ($alldata as $key => $payment)
                <tr>
                    ...
                    <th style="border: 1px solid red;padding:7px;">{{ number_format($payment->due_amount,2).' tk' }}</th>
                     @php
        ...
        <tbody>
            <tr>
                <th colspan="4" style="text-align: right;padding:8px;background: red;color:white">Total Due Amount:</th>
                <th><strong>{{ number_format($total_due,2)." Tk" }}</strong></th>
            </tr>
            @php
